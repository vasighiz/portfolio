            ...
            <div className="min-h-[calc(100vh-4rem)] bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8">
              <div className="relative w-32 h-32 mx-auto mb-6">
                ...
                <img
                  ...
                  alt="Profile"
                  className="relative w-full h-full rounded-full object-cover border-4 border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
                />
              </div>
              <h1 className="text-2xl font-bold text-[#0B1B2D] mb-2">Vahid Asighi</h1>
              <p className="text-[#334155] text-sm mb-8">PhD in Computer Science<br />Machine Learning & AI</p>
              <Outlet />
            </div>
          </div>
        </div>
