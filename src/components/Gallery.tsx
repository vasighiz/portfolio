...
const galleryItems: GalleryItem[] = [
  {
    id: 1,
    title: "Internship Project Course",
    description: "Applied Machine Learning with Python",
    detailedDescription: "Hands-on experience with Python and scikit-learn library for building machine learning models.",
